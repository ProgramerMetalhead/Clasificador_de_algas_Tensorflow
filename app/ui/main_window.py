...
from .widgets.calssifier_test_wiget import ClassifierTestWidget
...
class MainWindow(QMainWindow, appmethods):
    ...
    def show_message(self, titel, message, icon=QMessageBox.Icon.Warning):

        """
        Show Error Widget Message
        """
